...
I built a JARVIS-style assistant that runs locally. I used AI coding tools to write and wire the backend. For the models, I run Ollama and Qwen — I picked them because they are free and work well as local alternatives.
...
## Settings Form (AI Workflow Experiment)
